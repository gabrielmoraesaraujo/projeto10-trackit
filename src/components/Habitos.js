...
function AdicionaHabito({setAdicionarHabito, salvaNovoHabito, setHabitos}){
    ...
    return(
        ...
        <NovoHabitoContainer>
            <input value={nomeHabito} onChange={ e => setNomeHabito(e.target.value)} placeholder={{nomeHabito} ? "Nome do habito" : {nomeHabito}} type="text" />
            <DiasSemana>
                <DiasSemana cor={dias.includes(0) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(0)}>D</DiasSemana>
                <DiasSemana cor={dias.includes(1) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(1)}>S</DiasSemana>
                <DiasSemana cor={dias.includes(2) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(2)}>T</DiasSemana>
                <DiasSemana cor={dias.includes(3) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(3)}>Q</DiasSemana>
                <DiasSemana cor={dias.includes(4) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(4)}>Q</DiasSemana>
                <DiasSemana cor={dias.includes(5) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(5)}>S</DiasSemana>
                <DiasSemana cor={dias.includes(6) ? "#CFCFCF" : "white"} onClick={() => adicionaDia(6)}>S</DiasSemana>
...
function ListaHabitos({habitos, setHabitos}){
    ...
    function excluirHabito(indexHabito){
        ...
        return(
            <ListaHabitosLayout>
                {habitos.length > 0 ? habitos.map((habito, index) => <Habito habitod={habitod} index={index} excluirHabito={excluirHabito}/>) :""}
    ...
    return(
        <>
            ...
            <HabitosLayout>
                <Topo> 
                    <h1>Meus habitos</h1><BtnAdicionarHabitos onClick={() => {setAdicionarHabito(true)}}>+</BtnAdicionarHabitos>
